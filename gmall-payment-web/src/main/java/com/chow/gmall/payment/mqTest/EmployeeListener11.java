...
public class EmployeeListener11 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            MessageConsumer consumer = session.createDurableSubscriber(topic, "No.1");
                ...
                public void onMessage(Message message) {
                    if(message instanceof TextMessage){
                        try {
                            ...
                            System.out.println(text + "加油吧，兄嘚！");
